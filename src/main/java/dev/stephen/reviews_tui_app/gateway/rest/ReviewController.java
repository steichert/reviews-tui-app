...
public class ReviewController {
  ...
  public ResponseEntity<ReviewNoteDto> createNote(@RequestBody CreateNoteRequest request) {
    ...
    ReviewNoteDto noteDto =
        new ReviewNoteDto(request.content(), request.category(), request.tag(), null, null, null);
  ...
  public ResponseEntity<?> getSummary(
    ...
    if (colleague != null) {
      ...
      return ResponseEntity.badRequest()
          .body("Provide either 'colleague' or both 'from' and 'to' parameters");
    }
  }
}
