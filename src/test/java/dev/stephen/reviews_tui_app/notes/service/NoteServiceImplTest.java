...
class NoteServiceImplTest {
    ...
    @Mock private ColleagueService colleagueService;
    ...
    private ReviewNote buildNote(
            Long id, String content, NoteCategory category, NoteTag tag, Long colleagueId) {
    ...
    void createNote_savesEntityWithCorrectFields() {
        ReviewNoteDto input =
                new ReviewNoteDto(
                        "Great work",
                        NoteCategory.TECHNICAL_ABILITY,
                        NoteTag.HIGHLIGHT,
                        null,
                        null,
                        null);
        ReviewNote saved =
                buildNote(10L, "Great work", NoteCategory.TECHNICAL_ABILITY, NoteTag.HIGHLIGHT, 1L);
    ...
    void createNote_returnsDto_withSavedFieldsAndColleague() {
        ...
        ReviewNote saved =
                ReviewNote.builder()
                        .id(10L)
                        .content("Great work")
                        .category(NoteCategory.TECHNICAL_ABILITY)
                        .tag(NoteTag.HIGHLIGHT)
                        .colleagueId(1L)
                        .createdAt(savedAt)
                        .updatedAt(savedAt)
                        .build();
    ...
    void getSummaryForColleague_countsHighlightsAndImprovements() {
        List<ReviewNote> notes =
                List.of(
                        buildNote(
                                1L, "Good", NoteCategory.TECHNICAL_ABILITY, NoteTag.HIGHLIGHT, 1L),
    ...
    void getSummaryForAll_groupsNotesByColleague() {
        ColleagueDto bobDto =
                new ColleagueDto(2L, "Bob Jones", LocalDateTime.now(), LocalDateTime.now());
        List<ReviewNote> notes =
                List.of(
                        buildNote(
                                1L,
        ...
        assertThat(summaries)
                .extracting(ColleagueSummaryDto::colleagueName)
